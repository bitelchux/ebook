    ...
    TemplateManager.prototype = {
        ...
        loadToCache: function TemplateManager_loadToCache(tplNames, onSuccess) {
            ...
            if ($.isArray(tplNames)) {
                ...
                // for each template
                $.each(tplNames, function insertDataToTpl(index, fileName) {
                    /*jslint unparam: true */
                    // cache template html
        ...
        /**
         * Returns template completed by specified parameters including modifiers.
         *
         * @public
         * @param {string} tplHtml
         ...
         * @returns {string}
         */
        passThruModifiers: function passThruModifiers(tplHtml, tplParam,
                                                      content) {
